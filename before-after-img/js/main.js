...
var line_pos = parseInt($('.line').css('left')) * 100 / box_width; //позиция полосы в процентах
var left_img_width = parseInt($('.left-img').css('width')) * 100 / box_width; //шир левого изобр в процентах
...
$('.before-after-wrapper').mousedown(function (e) {
    flag = true;
    x0 = e.pageX;
    //    line_pos = parseInt($('.line').css('left'));
    //    console.log('left у line ' + line_pos + '(%)');
